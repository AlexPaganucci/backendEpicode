...
public class BookingManagementApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Role r1 = (Role)ctx.getBean("newRole", RoleType.ROLE_ADMIN);
		Role r2 = (Role)ctx.getBean("newRole", RoleType.ROLE_USER);
		User u1 = (User)ctx.getBean("newUser", "Alex Paganucci", "AlexP", "alex.paganucci@gmail.com");
